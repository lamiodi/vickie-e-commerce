    ...
    <section className="max-w-7xl mx-auto px-4 py-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="relative rounded-lg overflow-hidden h-[350px]">
          <img
            src="/woman-wearing-gray-seamless-leggings-gym.jpg"
            alt="Seamless Comfort"
          ...
          <div className="absolute bottom-8 left-8 text-white">
            ...
            <p className="text-sm opacity-80 mb-4">
              Get our Premium Seamless
              <br />
              Leggings with 30% off!
            </p>
            <Link
              to="/products"
        ...
        <div className="grid grid-cols-2 gap-4">
          {newProducts.length > 0 ? (
                ...
                <div className="bg-[#f5f5f5] rounded-lg p-4 mb-3 relative overflow-hidden aspect-square">
                  ...
                  <div className="absolute bottom-3 right-3 flex gap-1">
                    {[1, 2, 3, 4].map((i) => (
                      <span
                        key={i}
                        className={`w-1.5 h-1.5 rounded-full ${i === 1 ? 'bg-black' : 'bg-gray-300'}`}
                      />
                    ))}
                  </div>
                </div>
            ...
            <div className="col-span-2 flex items-center justify-center h-full bg-gray-50 rounded-lg">
