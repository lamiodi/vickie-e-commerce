        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-12">
            ...
            <p className="text-xs text-gray-600 leading-relaxed max-w-4xl">
              Welcome to Gymshark. We exist to unite the conditioning community. Designed for all
              levels of condition, we deliver premium, carefully considered products for those who
              aspire to be their best. Every rep counts for results. Being part of the Gymshark
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
            ...
            <div>
              <h4 className="font-bold text-sm mb-4">MORE ABOUT GYMSHARK</h4>
              <ul className="space-y-2 text-xs text-gray-600">
