    ...
    <div className="bg-gray-50 rounded-lg p-6 sticky top-6">
      ...
      <div className="space-y-4 max-h-64 overflow-y-auto pb-4 border-b border-gray-200">
        {items.map((item) => {
          ...
          const qtyParsed = typeof qtyRaw === 'string' ? parseInt(qtyRaw, 10) : qtyRaw;
          ...
          return (
            <div key={item.id} className="flex gap-3">
              <div className="relative">
                ...
                <span className="absolute -top-1 -right-1 w-5 h-5 bg-[#C41E3A] text-white text-xs font-bold rounded-full flex items-center justify-center shadow-md">
