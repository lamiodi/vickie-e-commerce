    ...
    <section className="max-w-7xl mx-auto px-4 py-12">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="col-span-1 row-span-2 relative rounded-lg overflow-hidden hidden lg:block">
          <img
            src="/pink-crop-hoodie-sportswear.jpg"
            alt="Pink Collection"
            className="w-full h-full object-cover"
          />
          <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent" />
          <div className="absolute bottom-8 left-6 text-white">
            <p className="text-xs tracking-wider mb-2 opacity-80">NEW SEASON</p>
            <h3 className="text-3xl font-bold mb-4">PINK COLLECTION</h3>
